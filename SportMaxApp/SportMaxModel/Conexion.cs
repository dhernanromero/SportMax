...
namespace SportMaxModel
{
    public class Conexion
    {
        ...
        private void Conectar()
        {
            ...
            //strCadenaDeConexion = "Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=SportMaxDB;Data Source=G100603NT1165\\SQLEXPRESS";
            strCadenaDeConexion = ConfigurationManager.ConnectionStrings["SportMaxDBConnection"].ConnectionString;
